  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth="2"
      />
      <rect x="14" y="30.5" width="20" height="2" rx="0.4" fill="url(#paint2_linear)" />
      <path
      ...
      <defs>
        ...
        <linearGradient id="paint1_linear" x1="24" y1="4.5" x2="24" y2="44.5" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FEE3A2" />
          <stop offset="1" stopColor="#F2A768" />
        </linearGradient>
        <linearGradient id="paint2_linear" x1="24" y1="30.5" x2="24" y2="32.5" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FEE3A2" />
          <stop offset="1" stopColor="#F2A768" />
        </linearGradient>
        <linearGradient id="paint3_linear" x1="24" y1="14.5" x2="24" y2="28.5" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FEE3A2" />
          <stop offset="1" stopColor="#F2A768" />
        </linearGradient>
      </defs>
